...
#ifndef CASINOCOIN_RPC_HANDLERS_HANDLERS_H_INCLUDED
#define CASINOCOIN_RPC_HANDLERS_HANDLERS_H_INCLUDED

#include <casinocoin/rpc/handlers/LedgerHandler.h>
...
Json::Value doNoCasinocoinCheck         (RPC::Context&);
