...
#ifndef CASINOCOIN_PROTOCOL_TXFLAGS_H_INCLUDED
#define CASINOCOIN_PROTOCOL_TXFLAGS_H_INCLUDED
...
// Payment flags:
const std::uint32_t tfNoCasinocoinDirect   = 0x00010000;
const std::uint32_t tfPartialPayment       = 0x00020000;
const std::uint32_t tfLimitQuality         = 0x00040000;
const std::uint32_t tfPaymentMask          = ~ (tfUniversal | tfPartialPayment | tfLimitQuality | tfNoCasinocoinDirect);

// TrustSet flags:
const std::uint32_t tfSetfAuth             = 0x00010000;
const std::uint32_t tfSetNoCasinocoin      = 0x00020000;
const std::uint32_t tfClearNoCasinocoin    = 0x00040000;
const std::uint32_t tfSetFreeze            = 0x00100000;
const std::uint32_t tfClearFreeze          = 0x00200000;
const std::uint32_t tfTrustSetMask         = ~ (tfUniversal | tfSetfAuth | tfSetNoCasinocoin | tfClearNoCasinocoin
