...
#ifndef CASINOCOIN_PROTOCOL_INDEXES_H_INCLUDED
#define CASINOCOIN_PROTOCOL_INDEXES_H_INCLUDED
...
uint256
getCasinocoinStateIndex (AccountID const& a, AccountID const& b, Currency const& currency);
