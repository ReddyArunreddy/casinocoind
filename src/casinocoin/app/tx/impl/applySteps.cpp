...
#include <casinocoin/app/tx/impl/CancelOffer.h>
...
#include <casinocoin/app/tx/impl/Payment.h>
...
invoke_preflight (PreflightContext const& ctx)
{
    ...
    case ttCRN_REPORT:      return CRNReport        ::preflight(ctx);
    case ttCRN_ROUND:
    case ttAMENDMENT:
...
invoke_preclaim (PreclaimContext const& ctx)
{
    ...
    case ttCRN_REPORT:      return invoke_preclaim<CRNReport>(ctx);
    case ttCRN_ROUND:
    case ttAMENDMENT:
...
invoke_calculateBaseFee(PreclaimContext const& ctx)
{
    ...
    case ttCRN_REPORT:      return CRNReport::calculateBaseFee(ctx);
    case ttCRN_ROUND:
    case ttAMENDMENT:
...
invoke_calculateConsequences(STTx const& tx)
{
    ...
    case ttCRN_REPORT:      return invoke_calculateConsequences<CRNReport>(tx);
...
invoke_apply (ApplyContext& ctx)
{
    ...
    case ttCRN_REPORT:      { CRNReport     p(ctx); return p(); }
    case ttCRN_ROUND:
    case ttAMENDMENT:
