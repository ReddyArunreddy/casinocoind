...
#ifndef CASINOCOIN_APP_MISC_VALIDATORLIST_H_INCLUDED
#define CASINOCOIN_APP_MISC_VALIDATORLIST_H_INCLUDED
...
/**
    ...
    Casinocoind accepts ledger proposals and validations from trusted validator
    ...
    This class manages the set of validation public keys the local casinocoind node
