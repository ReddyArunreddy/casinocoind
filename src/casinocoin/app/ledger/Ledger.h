...
#ifndef CASINOCOIN_APP_LEDGER_LEDGER_H_INCLUDED
#define CASINOCOIN_APP_LEDGER_LEDGER_H_INCLUDED
...
public:
    ...
    /** Create the Genesis ledger.
        ...
        The account has an CSC balance equal to the total amount
        of CSC in the system. No more CSC than the amount which
    ...
    */
    ...
    rawDestroyCSC (CSCAmount const& fee) override
    {
        ...
        // jrojek TODO: redirect that back to the pool via ttCRN_ROUND
        info_.drops -= fee;
